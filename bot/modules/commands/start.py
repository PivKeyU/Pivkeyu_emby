    ...
    try:
        ...
        try:
            ...
            if arg_prefix == "userip":
                ...
                return await sendMessage(msg, "🔒 这个参数只有主人能用。")
            ...
            await asyncio.gather(sendMessage(msg, "❓ 这个 start 参数不对哦。"), msg.delete())
            return
        ...
        await sendMessage(msg, "⚠️ /start 处理失败了，请稍后再试，或者让主人查看日志。")
