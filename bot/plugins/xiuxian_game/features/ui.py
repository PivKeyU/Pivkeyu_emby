...
def duel_keyboard(challenger_tg: int, defender_tg: int, stake: int, bet_minutes: int):
    return _legacy_service().duel_keyboard(challenger_tg, defender_tg, stake, bet_minutes)
